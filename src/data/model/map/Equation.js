...
(function(){
    ...
    Ext.define('mh.data.model.map.Equation', {
        ...
        fields: [
            ...
            {name: 'column', type: 'string', defaultValue: null},
            {name: 'customValue', type: 'number', defaultValue: null, allowNull: true },
            {name: 'arithmeticOperator', type: 'int', defaultValue: 0, allowNull: false },
