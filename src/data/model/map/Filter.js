...
(function(){
    ...
    Ext.define('mh.data.model.map.Filter', {
        ...
        fields: [
            ...
            {name: 'field', type: 'string', defaultValue: null},
            {name: 'operator', type: 'int', defaultValue: null},
            {name: 'value', type: 'auto', defaultValue: null},
            {name: 'join', type: 'int', defaultValue: 0, allowNull: true}
        ]
    });
}());