(function(){
     ...
     */
    Ext.define('mh.module.dataView.desktop.links.SingleLinkFieldController', {
        ...
        requires: [
            ...
            'mh.module.dataView.desktop.links.SingleLinkFieldLocalization'
        ],
        ...
        /**
         * Gets the current changes in a form of a diff. Returns an object that contains the valid Links collections
         */
        getChanges: function(){
