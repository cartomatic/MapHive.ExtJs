(function(){
     ...
     */
    Ext.define('mh.module.dataView.desktop.links.SingleLinkField', {
        ...
        requires: [
            'mh.mixin.ApiMap',
            'mh.module.dataView.desktop.links.SingleLinkFieldController'
        ],
        ...
        /**
         * @event change
         * @param {mh.module.dataView.desktop.links.SingleLinkField} this
         * @param newV
         * @param oldV
         */
