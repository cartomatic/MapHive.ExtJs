...
(function(){
     ...
     */
    Ext.define('mh.module.dataView.desktop.links.LinksPicker', {
        extend: 'Ext.Dialog',

        requires: [
            'mh.module.dataView.desktop.links.LinksPickerController',
            'mh.module.dataView.desktop.links.LinksPickerModel'
        ],
