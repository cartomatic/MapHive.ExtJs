...
(function(){
    ...
    Ext.define('mh.module.dataView.desktop.links.LinksGrid', {
        ...
        requires: [
            'mh.module.dataView.desktop.links.LinksGridController',
            'mh.module.dataView.desktop.links.LinksGridModel',
            'mh.plugin.grid.DragDrop'
        ],

        controller: 'mh-desktop-links-grid',
        viewModel:{
            type: 'mh-desktop-links-grid'
        },
